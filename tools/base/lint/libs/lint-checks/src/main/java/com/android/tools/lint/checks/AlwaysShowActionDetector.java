...
public class AlwaysShowActionDetector extends ResourceXmlDetector implements
    ...
    public void visitReference(@NonNull JavaContext context, @Nullable UastVisitor visitor,
            @NonNull USimpleReferenceExpression reference, @NonNull UElement referenced) {
        if (referenced instanceof UVariable
                &&  JavaEvaluator.isMemberInClass((UVariable) referenced,
                "android.view.MenuItem")) {
            if ("SHOW_AS_ACTION_ALWAYS".equals(reference.getIdentifier())) {
